...
describe('number scanner', () => {
  describe('splitIntoDigits', () => {
    it('gets nine digits', () => {
      ...
      expect(splitIntoDigits(input)).toHaveLength(19);
    });

    it('represents digits as strings', async () => {
      const input = [
        ' _  _  _  _  _  _  _  _  _ ',
        '| || || || || || || || || |',
        '|_||_||_||_||_||_||_||_||_|'
    ...
    it('returns digits of correct length', async () => {
      const input = [
        ' _  _  _  _  _  _  _  _  _ ',
        '| || || || || || || || || |',
        '|_||_||_||_||_||_||_||_||_|'
      ...
      digits.map(digit => expect(digit).toHaveLength(19));
    });
